...
export const projects: Project[] = [
  {
    ...
    imageUrl: 'https://via.placeholder.com/400x225/021022/00ffff?text=Project+Thumbnail+1',
    links: [
      { url: '#', type: 'live' },
      { url: '#', type: 'code' },
    ],
  },
  {
    ...
    imageUrl: 'https://via.placeholder.com/400x225/021022/00ffff?text=Project+Thumbnail+2',
    links: [
      { url: '#', type: 'live' },
      { url: '#', type: 'code' },
    ],
  },
  {
    ...
    imageUrl: 'https://via.placeholder.com/400x225/021022/00ffff?text=Project+Thumbnail+3',
    links: [
